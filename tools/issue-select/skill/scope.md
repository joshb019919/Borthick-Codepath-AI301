...
=======================
Languages: Python, SQL, Java, Jenkins, Groovy, JavaScript, C/C++, Lua.
Frameworks: Flask, Spring, Spring Boot, React, Lua Love2D.
Shells: Bash, Windows CMD, Windows PowerShell.
Tools & Libraries: Torch, TensorFlow, Scikit-Learn, PySpark, ScyPy, Pickle, Jackson.
Techniques: AI model design and optimization, feature engineering, data analysis, Python async, 2D side-scroller games (all in theory and college coursework).

==============================
What I'd Like to Get Better At
==============================
Languages: Rust, Go
Frameworks: WASM, Axum (Rust), Leptos (Rust)
Techniques:  AI optimization, async, and model design in practice; microservices and serverless architectures.
